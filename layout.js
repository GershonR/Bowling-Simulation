function loadFloor() {
		...
		var cylinder2 = new THREE.Mesh( new THREE.CylinderGeometry( 17, 17, 1100, 12 ), new THREE.MeshPhongMaterial({color: 0x000000}) );
		...
		var cylinder4 = new THREE.Mesh( new THREE.CylinderGeometry( 16, 16, 1100, 12 ), new THREE.MeshPhongMaterial({color: 0x000000}) );
		cylinder4.rotation.z = -(Math.PI / 2);
		cylinder4.position.y = 6;
		cylinder4.position.x = -500;
		cylinder4.position.z = -80;
		
		var cylinder5 = new THREE.Mesh( new THREE.CylinderGeometry( 15.5, 15.5, 1100, 12 ), new THREE.MeshPhongMaterial({color: 0x000000}) );
